...
namespace OpenBve {
	internal static class TextureManager {
		...
		internal static int RegisterTexture(string FileName, TextureWrapMode WrapModeX, TextureWrapMode WrapModeY, bool DontAllowUnload) {
			return RegisterTexture(FileName, new RGBb(0, 0, 0), 0, TextureLoadMode.Normal, WrapModeX, WrapModeY, DontAllowUnload, 0, 0, 0, 0);
		}
		internal static int RegisterTexture(string FileName, RGBb TransparentColor, byte TransparentColorUsed, TextureWrapMode WrapModeX, TextureWrapMode WrapModeY, bool DontAllowUnload) {
		...
		internal static int RegisterTexture(string FileName, RGBb TransparentColor, byte TransparentColorUsed, TextureLoadMode LoadMode, TextureWrapMode WrapModeX, TextureWrapMode WrapModeY, bool DontAllowUnload, int ClipLeft, int ClipTop, int ClipWidth, int ClipHeight) {
		...
		// find texture
		private static int FindTexture(string FileName, RGBb TransparentColor, byte TransparentColorUsed, TextureLoadMode LoadMode, TextureWrapMode WrapModeX, TextureWrapMode WrapModeY, int ClipLeft, int ClipTop, int ClipWidth, int ClipHeight) {
		...
		// load texture rgba
		private static void LoadTextureRGBAforData(Bitmap Bitmap, RGBb TransparentColor, byte TransparentColorUsed, int TextureIndex) {
			try {
				// load bytes
				int Width, Height, Stride; byte[] Data;
				{
