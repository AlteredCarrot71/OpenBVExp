...
namespace OpenBve {
	internal static class Game {
		...
		internal struct Fog {
			...
			internal Fog(float Start, float End, RGBb Color, double TrackPosition) {
				this.Start = Start;
				this.End = End;
				this.Color = Color;
		...
		internal static Fog PreviousFog = new Fog(NoFogStart, NoFogEnd, new RGBb(128, 128, 128), 0.0);
		internal static Fog CurrentFog = new Fog(NoFogStart, NoFogEnd, new RGBb(128, 128, 128), 0.5);
		internal static Fog NextFog = new Fog(NoFogStart, NoFogEnd, new RGBb(128, 128, 128), 1.0);
		...
		internal static void Reset(bool ResetLogs) {
			...
			PreviousFog = new Fog(NoFogStart, NoFogEnd, new RGBb(128, 128, 128), 0.0);
			CurrentFog = new Fog(NoFogStart, NoFogEnd, new RGBb(128, 128, 128), 0.5);
			NextFog = new Fog(NoFogStart, NoFogEnd, new RGBb(128, 128, 128), 1.0);
